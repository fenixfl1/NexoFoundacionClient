...
/**
 * @deprecated This function is deprecated, instead, use `useErrorHandler`
 * @description Maneja errores de solicitud mostrando mensajes adecuados según el modo y tipo de error.
